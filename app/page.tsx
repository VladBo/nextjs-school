...
import { BookOpen, Code, Users, Calendar, ArrowRight, GraduationCap } from "lucide-react"
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Comprehensive computer science education covering programming fundamentals, algorithms, and modern
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-8 lg:grid-cols-3 lg:gap-12">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Learn the basics of programming with Python, Java, and C++. Build a strong foundation in
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Master HTML, CSS, JavaScript, and modern frameworks. Create responsive and interactive web
                    applications.
                  </CardDescription>
                </CardHeader>
              </Card>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Work on real-world projects and collaborate with peers. Develop practical skills for the tech
                    industry.
                  </CardDescription>
                </CardHeader>
              </Card>
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-8 lg:grid-cols-2 lg:gap-12">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Learn programming fundamentals using Python. Cover variables, loops, functions, and basic data
                    structures.
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Advanced concepts including object-oriented programming, algorithms, and data structures using Java
                    and C++.
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Create modern websites using HTML, CSS, JavaScript, and popular frameworks like React.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="flex items-center space-x-4 text-sm text-gray-500">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Preparation for programming competitions and olympiads. Advanced algorithms and problem-solving
                    techniques.
                  </CardDescription>
                </CardHeader>
                <CardContent>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Stay updated with the latest news from our computer science program.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-8 lg:grid-cols-3 lg:gap-12">
              <Card>
                <CardHeader>
                  ...
                  <CardTitle className="text-lg">Programming Competition Success</CardTitle>
                  <CardDescription>
                    Our students won 1st place in the regional programming olympiad, demonstrating exceptional
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardTitle className="text-lg">New Web Development Module</CardTitle>
                  <CardDescription>
                    Added React and modern JavaScript frameworks to our web development curriculum for the spring
                    semester.
                  </CardDescription>
                </CardHeader>
              </Card>
              <Card>
                <CardHeader>
                  ...
                  <CardTitle className="text-lg">Tech Industry Guest Speaker</CardTitle>
                  <CardDescription>
                    Software engineer from a leading tech company shared insights about career paths in computer
                    science.
                  </CardDescription>
                </CardHeader>
              </Card>
