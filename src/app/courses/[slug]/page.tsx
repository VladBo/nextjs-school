...
const getCourse = async (slug: string): Promise<Course | null> => {
  // Simulate fetching course data based on slug
  // In a real application, fetch from a database or CMS
  const courses: { [key: string]: Course } = {
    "intro-programming": {
      title: "Introduction to Programming",
      subtitle: "Learn Python fundamentals and computational thinking",
      description:
        "This course introduces students to the fundamental concepts of programming using Python. Students will learn to think computationally and solve problems through code.",
      badge: "Grade 9-10",
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      3rd place in beginner category
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-2">
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              Introduction to Programming is designed for students with little
              to no programming experience. Through hands-on projects and
              interactive exercises, students will master the fundamentals of
              Python programming while developing critical thinking and
              problem-solving skills.
            </p>
            <p className="text-gray-600 leading-relaxed">
              By the end of this course, students will be able to write simple
              programs, understand basic algorithms, and have a solid foundation
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              <li className="flex items-start gap-2">
                ...
                Understand fundamental programming concepts including variables,
          ...
          <div>
            ...
            <p className="text-gray-600 mb-4">
              If you have any questions about this course or need additional
