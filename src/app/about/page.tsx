              ...
              <div className="flex flex-col justify-center space-y-4">
                ...
                <div className="space-y-4">
                  <p className="text-gray-600 leading-relaxed">
                    With over 15 years of experience in computer science
                    education at Lutsk School №2, I am dedicated to inspiring
                    students to explore the fascinating world of programming and
                    technology. My mission is to make computer science
                    accessible, engaging, and relevant to students of all
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    foundations with hands-on projects that connect to
                ...
                <div className="space-y-4">
                  ...
                  <Card>
                    <CardHeader className="pb-3">
                      ...
                      <CardDescription>
                        Coached students to 15+ regional and national
        ...
        <section className="w-full py-8 md:py-12 lg:py-16 bg-gray-50">
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
              ...
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed">
                Feel free to reach out for questions about courses,
                collaboration opportunities, or educational resources.
              </p>
            </div>
